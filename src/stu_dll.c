...
#include "game/components/health_component.c"
#include "game/components/auto_destroy_component.c"
#include "game/components/update_callback_component.c"
#include "game/components/velocity_component.c"
#include "game/components/shooting_component.c"
#include "game/components/target_component.c"
#include "game/components/enemy_plane_behavior_component.c"
